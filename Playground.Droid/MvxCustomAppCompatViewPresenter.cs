...
{
    public class MvxCustomAppCompatViewPresenter : MvxAndroidViewPresenter
    {
        public MvxCustomAppCompatViewPresenter(IEnumerable<Assembly> androidViewAssemblies) : base(androidViewAssemblies)
        {
